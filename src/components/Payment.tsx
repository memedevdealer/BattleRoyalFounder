...
export const Payment = () => {
  ...
  const handlePayClick = (amount: number, tier: string) => {
    const url = createSolanaPayURL(amount);
    // Try to open in Solana wallet
  ...
  return (
    <section className="w-full max-w-4xl mx-auto px-4 pb-20">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-400">Transfer SOL to the official Founders Contract</p>
        {isDevnet && (
      ...
      <FounderRegistrationDialog
        ...
        onSuccess={() => {
          // Refresh the page or trigger a refresh of the Wall of Warriors
